    ...
    <div class="notification-page">
        ...
        <div class="status-tabs-wrap">
            <div class="status-tabs">
                ...
                <a href="?status=pending" class="status-tab {{ request('status', 'all') === 'pending' ? 'active' : '' }}">
                    Menunggu <span class="badge">{{ $pendingCount }}</span>
                </a>
                <a href="?status=approved" class="status-tab {{ request('status', 'all') === 'approved' ? 'active' : '' }}">
                    Disetujui <span class="badge">{{ $approvedCount }}</span>
                </a>
                <a href="?status=rejected" class="status-tab {{ request('status', 'all') === 'rejected' ? 'active' : '' }}">
